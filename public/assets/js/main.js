    ...
    if (target.length > 0) {
        target.each(function() {
            ...
            if (
                ...
                console.log('---------targetxxx---------');
                console.log(dataAnimateIn, );
                console.log(dataAnimateOut);
                console.log(dataDefaultItem);
                console.log('---------targetxxxx---------');

                el.addClass('owl-carousel').owlCarousel({
                    animateIn: dataAnimateIn,
                    animateOut: dataAnimateOut,
                    items: dataDefaultItem, //problema aqui
                    loop: dataLoop,
                    speed: 1000,
